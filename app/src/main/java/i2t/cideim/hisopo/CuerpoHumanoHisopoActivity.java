...
public class CuerpoHumanoHisopoActivity extends AppCompatActivity implements View.OnTouchListener {
    ...
    static boolean modo_nueva_lesion = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cuerpo_humano_hisopo_activity);
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        if (focus) {
            ...
            Log.e("MODO","Estado: "+modo_nueva_lesion);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                Log.e("ATENCION",""+tronco_active);
                parte = getParteDelCuerpo(event.getX() / ancho, event.getY() / alto);
                if (parte == CABEZA && cabeza_active && modo_nueva_lesion) {
                    Intent i = new Intent(this, CabezaHisopoActivity.class);
                    startActivity(i);
                } else if (parte == TRONCO && tronco_active && modo_nueva_lesion) {
                    Intent i = new Intent(this, TroncoHisopoActivity.class);
                    startActivity(i);
                } else if (parte == BRAZO_DERECHO && brazo_der_active && modo_nueva_lesion) {
                    Intent i = new Intent(this, BrazoDerechoHisopoActivity.class);
                    startActivity(i);
                } else if (parte == BRAZO_IZQUIERDO && brazo_izq_active && modo_nueva_lesion) {
                    Intent i = new Intent(this, BrazoIzquierdoHisopoActivity.class);
                    startActivity(i);
                } else if (parte == PIERNA_DERECHA && pierna_der_active && modo_nueva_lesion) {
                    Intent i = new Intent(this, PiernaDerechaHisopoActivity.class);
                    startActivity(i);
                } else if (parte == PIERNA_IZQUIERDA && pierna_izq_active && modo_nueva_lesion) {
                    Intent i = new Intent(this, PiernaIzquierdaHisopoActivity.class);
                    startActivity(i);
                } else if (parte == MANO_DERECHA && mano_der_active && modo_nueva_lesion) {
                    Intent i = new Intent(this, ManoDerechaHisopoActivity.class);
                    startActivity(i);
                } else if (parte == MANO_IZQUIERDA && mano_izq_active && modo_nueva_lesion) {
                    Intent i = new Intent(this, ManoIzquierdaHisopoActivity.class);
                    startActivity(i);
                }
                return false;
        }
                ...
                label_cabeza.setOnTouchListener(new View.OnTouchListener() {
                    ...
                    public boolean onTouch(View v, MotionEvent event) {
                        if (event.getAction() == MotionEvent.ACTION_DOWN) {
                            ...
                            Intent i = new Intent(getApplicationContext(), CabezaHisopoActivity.class);
                            //startActivity(i);
                        }
                        return true;
                    }
                ...
                label_tronco.setOnTouchListener(new View.OnTouchListener() {
                    ...
                    public boolean onTouch(View v, MotionEvent event) {
                        if (event.getAction() == MotionEvent.ACTION_DOWN) {
                            ...
                            Intent i = new Intent(getApplicationContext(), TroncoHisopoActivity.class);
                            //startActivity(i);
                        }
                        return true;
                    }
                ...
                label_brazo_derecho.setOnTouchListener(new View.OnTouchListener() {
                    ...
                    public boolean onTouch(View v, MotionEvent event) {
                        if (event.getAction() == MotionEvent.ACTION_DOWN) {
                            ...
                            Intent i = new Intent(getApplicationContext(), BrazoDerechoHisopoActivity.class);
                            //startActivity(i);
                        }
                        return true;
                    }
                ...
                label_brazo_izquierdo.setOnTouchListener(new View.OnTouchListener() {
                    ...
                    public boolean onTouch(View v, MotionEvent event) {
                        if (event.getAction() == MotionEvent.ACTION_DOWN) {
                            ...
                            Intent i = new Intent(getApplicationContext(), BrazoIzquierdoHisopoActivity.class);
                            //startActivity(i);
                        }
                        return true;
                    }
                ...
                label_pierna_derecha.setOnTouchListener(new View.OnTouchListener() {
                    ...
                    public boolean onTouch(View v, MotionEvent event) {
                        if (event.getAction() == MotionEvent.ACTION_DOWN) {
                            ...
                            Intent i = new Intent(getApplicationContext(), PiernaDerechaHisopoActivity.class);
                            //startActivity(i);
                        }
                        return true;
                    }
                ...
                label_pierna_izquierda.setOnTouchListener(new View.OnTouchListener() {
                    ...
                    public boolean onTouch(View v, MotionEvent event) {
                        if (event.getAction() == MotionEvent.ACTION_DOWN) {
                            ...
                            Intent i = new Intent(getApplicationContext(), PiernaIzquierdaHisopoActivity.class);
                            //startActivity(i);
                        }
                        return true;
                    }
                ...
                label_mano_derecha.setOnTouchListener(new View.OnTouchListener() {
                    ...
                    public boolean onTouch(View v, MotionEvent event) {
                        if (event.getAction() == MotionEvent.ACTION_DOWN) {
                            ...
                            Intent i = new Intent(getApplicationContext(), ManoDerechaHisopoActivity.class);
                            //startActivity(i);
                        }
                        return true;
                    }
                ...
                label_mano_izquierda.setOnTouchListener(new View.OnTouchListener() {
                    ...
                    public boolean onTouch(View v, MotionEvent event) {
                        if (event.getAction() == MotionEvent.ACTION_DOWN) {
                            ...
                            Intent i = new Intent(getApplicationContext(), ManoIzquierdaHisopoActivity.class);
                            //startActivity(i);
                        }
                        return true;
                    }
    ...
    public void activar_modo_nueva_lesion() {
        Log.e("ATENCION","MODO NUEVA LESION ACTIVADO!");
        hideButtons();

...
public class EntryDialog extends DialogFragment implements View.OnClickListener{
    ...
    public static EntryDialog newInstance(String texto, String cedula, int bodyLoc, String confirmacion) {
    ...
    public void onClick(View v) {
        Button b = (Button) v;
        if(b.equals(ok)){
            onDialogDismiss.finish(this, entry.getText().toString(), bodylocation);
        }
    }

    public interface OnDialogDismiss{
        void finish(EntryDialog dialog, String sintoma, int bodylocation);
    }
